...
#Feature (0,1)-Economy Family
#Feature (0,2)-Economy Health
#Feature (0,3)-Economy Freedom
#Feature (0,6)-Economy Dystopia
#Feature (1,2)-Family Health
#Feature (1,3)-Family Freedom
#Feature (1,6)-Family Dystopia
#Feature (2,3)-Health Freedom
#Feature (2,6)-Health Dystopia
...
def compute_cost(X,Y,i,j,k):
    ...
    #for j in range(len(two_feature)):
    X2=XX[:,two_feature[k]]
    w1 = initalize_weights(3, i)
...
for i in range(1,100,5):
    for k in range(len(two_feature)):
        pl=[]
        nl=[]
        ...
        featurevec.append([two_feature[k],min(pl),nl[index]])
        
for j2 in range(len(two_feature)):
    features=[]
    error=[]
    neurons=[]
    for i2 in range(j2,len(featurevec),len(two_feature)):
